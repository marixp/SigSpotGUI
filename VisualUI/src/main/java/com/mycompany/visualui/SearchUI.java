...
public class SearchUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sResultsPanel = new javax.swing.JPanel();
        resultLabel = new javax.swing.JLabel();
        sResultsPane = new javax.swing.JScrollPane();
        sResultsList = new javax.swing.JList<>();
        ...
        sResultsPanel.setBackground(new java.awt.Color(153, 255, 255));
        sResultsPanel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 255), 2));
        sResultsPanel.setForeground(new java.awt.Color(255, 255, 0));
        sResultsPanel.setAlignmentX(0.0F);
        sResultsPanel.setAlignmentY(2.0F);
        sResultsPanel.setMaximumSize(new java.awt.Dimension(400, 750));
        sResultsPanel.setMinimumSize(new java.awt.Dimension(400, 750));
        sResultsPanel.setPreferredSize(new java.awt.Dimension(400, 750));
        sResultsPanel.setLayout(new java.awt.BorderLayout(10, 0));
        ...
        sResultsPanel.add(resultLabel, java.awt.BorderLayout.PAGE_START);

        sResultsPane.setBackground(new java.awt.Color(255, 255, 255));
        sResultsPane.setBorder(null);
        sResultsPane.setForeground(new java.awt.Color(0, 0, 255));
        sResultsPane.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        sResultsPane.setColumnHeaderView(null);
        sResultsPane.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        sResultsPane.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        sResultsPane.setHorizontalScrollBar(null);
        sResultsPane.setMaximumSize(new java.awt.Dimension(400, 695));
        sResultsPane.setMinimumSize(new java.awt.Dimension(400, 695));
        sResultsPane.setPreferredSize(new java.awt.Dimension(400, 695));
        sResultsPane.setRowHeaderView(null);
        sResultsPane.setViewportView(sResultsList);

        sResultsList.setBackground(new java.awt.Color(255, 255, 255));
        sResultsList.setBorder(null);
        sResultsList.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        sResultsList.setForeground(new java.awt.Color(0, 0, 255));
        sResultsList.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        sResultsList.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        sResultsList.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        sResultsList.setMaximumSize(new java.awt.Dimension(396, 695));
        sResultsList.setMinimumSize(new java.awt.Dimension(396, 695));
        sResultsList.setPreferredSize(new java.awt.Dimension(396, 695));
        sResultsList.setSelectionBackground(new java.awt.Color(0, 102, 255));
        sResultsList.setSelectionForeground(new java.awt.Color(255, 255, 255));
        sResultsList.setVisibleRowCount(25);
        sResultsPane.setViewportView(sResultsList);

        sResultsPanel.add(sResultsPane, java.awt.BorderLayout.CENTER);
        ...
        getContentPane().add(sResultsPanel, gridBagConstraints);
    ...
    private javax.swing.JList<String> sResultsList;
    private javax.swing.JScrollPane sResultsPane;
    public javax.swing.JPanel sResultsPanel;
